...
func TestFindLargestProduct(t *testing.T) {
	...
	tests := []testData{testcase1, testcase2}
	for _, value := range tests {
		actualResult := FindLargestProduct(value.input)
		if actualResult != value.output {
			t.Errorf("TestFindLargestProduct of (%d) was incorrect, got: %d, want: %d.", value.input, actualResult, value.output)
		}
	}
}
